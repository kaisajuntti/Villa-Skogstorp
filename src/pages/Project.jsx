...
export default function Project() {
  ...
  return (
    <div className="page">
      ...
      <h2>Försättsblad (PDF)</h2>
      <CoverInfo space={space} update={update} />

      <h2>Kommentarer & bilder per rum</h2>
      <p className="sub">Allt du placerat på rummens planritningar, samlat per rum. Skapa en PDF för hela projektet (försättsblad + alla rum) eller tryck 🖨 vid ett enskilt rum — planritning + kommentarer/bilder att skriva ut eller skicka till hantverkaren.</p>
      <RoomsCommentBrowser cover={space.cover} colors={space.colors} />

      <h2>Anteckningar</h2>
      <p className="sub" style={{ marginTop: -4 }}>Kladdanteckningar — snabba, tillfälliga noteringar. För en samlad beskrivning, använd “Beskrivning” under Dokument & länkar.</p>
