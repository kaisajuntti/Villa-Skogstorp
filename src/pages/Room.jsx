...
import { ColorScheme, DocList, Notes, PlanCollection, InventoryList } from "../components/Spaces.jsx";
          ...
          <div className="page" style={{ paddingTop: 6 }}>
            {!space ? (
              ...
              <>
                ...
                {tab === "dokument" && (<><h2>Dokument & länkar — {room.name}</h2><DocList space={space} update={update} /><InventoryList roomId={room.id} space={space} update={update} /><PlanCollection roomId={room.id} /></>)}
